...
export default () => {
  const url =
    "http://10.3.53.47:30219/api/datasources/proxy/3/loki/api/v1/query_range?direction=BACKWARD&limit=1000&query=%7Bapp%3D%22promtail%22%2Cnamespace%3D%22default%22%7D&start=1689043695000000000&end=1689216496000000000&step=300";
  const headers = {
    Authorization:
